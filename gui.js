...
const sampleBuffer1 = new Tone.ToneAudioBuffer(
  "grainsynth/samples/audio/SH-el.mp3",
  () => {
    console.log("loaded");
  }
);
const sampleBuffer2 = new Tone.ToneAudioBuffer(
  "grainsynth/samples/audio/guitar.wav",
  () => {
    // console.log('loaded');
  }
);
const sampleBuffer3 = new Tone.ToneAudioBuffer(
  "grainsynth/samples/audio/piano+spaceecho.mp3",
  () => {
    // console.log('loaded');
  }
);
const sampleBuffer4 = new Tone.ToneAudioBuffer(
  "data/music/Theremin_Hauptstimme_ohne_Stille.wav",
  () => {
    // console.log('loaded');
  }
);
const SourceInput = gs.addInput(PARAMS, "source", {
  options: { Synthetic_Sound: 0, Guitar: 1, Piano: 2, Theremin_Melody_1: 3 },
});
...
const attackInput = f.addInput(PARAMS, "grainSize", {
  min: 0.01,
  max: 0.1,
  step: 0.01,
});
...
const decayInput = f.addInput(PARAMS, "overlap", {
  min: 0.0,
  max: 0.1,
  step: 0.01,
});
...
const changePBR = f.addInput(PARAMS, "playbackrate", {
  min: 0.01,
  max: 2,
  step: 0.01,
});
